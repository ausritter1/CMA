...
tool = YoutubeVideoSearchTool(youtube_video_url='https://www.youtube.com/watch?v=D1GTnaFA5gw')
...
research_task = Task(
  ...
  expected_output='A comprehensive 3 paragraphs long report on the startup that presents.',
  tools=[tool],
  agent=researcher,
)
...
result = crew.kickoff(inputs={'topic': 'AI in Venture Capital operations'})
print(result)